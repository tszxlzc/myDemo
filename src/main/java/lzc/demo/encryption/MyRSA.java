...
public class MyRSA {
	...
	public static Map<String, byte[]> generateKeyBytes() {
		...
		try {
			...
			System.out.println("公钥为：" + new BASE64Encoder().encode(publicKey.getEncoded()));
			System.out.println("私钥为：" + new BASE64Encoder().encode(privateKey.getEncoded()));
